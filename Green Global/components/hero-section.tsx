        ...
        <section className="relative w-full overflow-hidden bg-green-950 text-cream-50">
            ...
            <div className="container relative z-10 mx-auto px-4 py-20 md:py-32 flex flex-col justify-center h-full">
                <div className="max-w-2xl space-y-6 animate-slide-up">
                    ...
                    <h1 className="font-serif text-4xl md:text-6xl font-bold leading-tight text-white drop-shadow-sm">
                        Source the Rarest <br />
                        <span className="text-gold-500 italic">Borneo Aroids</span>
                    </h1>

                    <p className="text-base md:text-lg text-green-100 max-w-lg leading-relaxed">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4">
                        <Link
                            href="/catalog"
                            className="inline-flex items-center justify-center bg-gold-500 hover:bg-gold-600 text-green-950 px-6 py-3 rounded-full font-bold text-sm uppercase tracking-widest transition-transform hover:scale-105"
                        >
                            Shop Catalog
                        ...
                        <Link
                            href="/about"
                            className="inline-flex items-center justify-center bg-white/10 hover:bg-white/20 border border-white/20 backdrop-blur text-white px-6 py-3 rounded-full font-bold text-sm uppercase tracking-widest transition-colors"
                        >
                            Export Process
                        </Link>
                    </div>
            ...
            {/* Bar Kredibilitas */}
            <div className="relative z-20 border-t border-white/10 bg-green-950/40 backdrop-blur-md">
